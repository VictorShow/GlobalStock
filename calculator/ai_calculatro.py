...
class Calculator:
    ...
    def add_model():
        ...
        saver.save(sess, './calculator_add_model/', global_step=1000)    # 세션에 있는 내용을 파일로 저장..
    ...
    def sub_model():
        ...
        saver.save(sess, './calculator_sub_model/', global_step=1000)
    ...
    def mul_model():
        ...
        saver.save(sess, './calculator_mul_model/', global_step=1000)
    ...
    def div_model():
        ...
        saver.save(sess, './calculator_div_model/', global_step=1000)
    ...
    def service(num1, num2, opcode):
        ...
        with tf.Session() as sess:
            sess.run(tf.global_variables_initializer())
            saver = tf.train.import_meta_graph(f'calculator/calculator_{opcode}_model/-1000.meta')
